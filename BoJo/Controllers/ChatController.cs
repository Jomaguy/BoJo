...
namespace BoJo.Controllers
{
    public class ChatController : Controller
    {
        ...
        private string DBSTRING = "Server=tcp:secondbojoserver.database.windows.net,1433;Initial Catalog=Bojo;Persist Security Info=False;User ID=Adminuser;Password=BoJo2023@;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
